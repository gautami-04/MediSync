	...
	return (
		<div className={styles.layout}>
			<aside className={styles.sidebar}>
				...
				<Link to="/book-appointment" className={styles.newAppointmentBtn} style={{ textDecoration: 'none', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
